...
// CHECK: module {
// CHECK-NEXT: p4.control @Pipe(%arg0: ui10, %arg1: si16) {
...
// CHECK-NEXT: %0 = p4.self : !p4.ref<!p4.control<"Pipe">>
// CHECK-NEXT: %1 = p4.constant 2 : ui10
...
// CHECK-NEXT: p4.apply {
// CHECK-NEXT: %0 = p4.self : !p4.ref<!p4.control<"Pipe">>
// CHECK-NEXT: %1 = p4.copy(%arg0) : ui10 -> ui10
...
// CHECK-NEXT: ^bb2(%12: si16):  // 2 preds: ^bb0, ^bb1
// CHECK-NEXT: p4.return
// CHECK-NEXT: }
// CHECK-NEXT: }
// CHECK-NEXT: }
